...
class ProductController extends Controller
{
    ...
    public function show(Product $product)
    {
        ...
        $related_product = Product::where('category_id', $product->category_id)->where('id', '!=', $product->id)->limit(3)->get();
    ...
    public function addToChart(Request $request)
    {
        ...
        return redirect('/products')->with('success', 'Product Added Your Cart');
    }
